...
public class HoldingController {
  ...
  public ResponseEntity<ApiResponse<HoldingListResponse>> getHoldings(
    ...
    return ResponseEntity.ok(ApiResponse.success(holdingService.getHoldings(accountId)));
  }
  ...
  public ResponseEntity<ApiResponse<HoldingReturnsResponse>> getReturns(
      @RequestParam Long accountId) {
    return ResponseEntity.ok(ApiResponse.success(holdingService.getReturns(accountId)));
  }
}
